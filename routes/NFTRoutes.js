...
const { createNftItem, getNfts, getOwnedNft, likeNft, disLikeNft, getLikedNftByAccount, getSingleNft, minted } = require('../controllers/NftController');
